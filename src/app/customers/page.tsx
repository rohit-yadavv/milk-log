            ...
            <DrawerContent>
              ...
              <div className="px-4 space-y-4">
                ...
                <Select
                  ...
                  onValueChange={(value: "milkman" | "regular") =>
                ...
                {newCustomer.customerType === "regular" && (
                  <input
                    ...
                    onChange={(e) =>
                      setNewCustomer({
                        ...newCustomer,
                        dailyAmount: parseFloat(e.target.value) || 0,
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                  />
                ...
                {newCustomer.customerType === "milkman" && (
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Milkmen have variable quantities - amounts will be entered
                    for each delivery
                  </p>
                )}
              </div>
              <DrawerFooter>
                ...
                <DrawerClose asChild>
                  <Button variant="outline" disabled={isCreatingCustomer}>
                    Cancel
                  </Button>
                </DrawerClose>
              </DrawerFooter>
